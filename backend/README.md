...
This directory (**Setu**) is the backend: the event-driven engine underneath
the agent. Two layers live in it, and keeping them ignorant of each other is
the point:
...
The frontend (**vedai-studio**) lives alongside this at [`../frontend`](../frontend).

Run everything below from this directory (`backend/`).
